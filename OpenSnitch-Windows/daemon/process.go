...
// getCommandLine retrieves the command line of the process identified by pid.
// If the process cannot be opened with the required rights, an error is returned.
// Currently the function does not extract the real command line across architectures
// and returns the placeholder string "<Command Line Not Available>" on success.
